...
public class BookResourceImpl implements Resource<Book> {
	...
	@Override
	public ResponseEntity<Page<Book>> findByClass(Pageable pageable, String searchText, Long id) {
		return null;
	}

	@Override
	public ResponseEntity<Page<Book>> findByClass(Long id, int pageNumber, int pageSize, String sortBy, String sortDir) {
		return null;
	}
