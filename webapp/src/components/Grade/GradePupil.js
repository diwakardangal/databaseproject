...
class GradePupil extends Component {
    constructor(props) {
        super(props);
        this.state = {
            users : [],
    ...
    findAllUsers(currentPage) {
        ...
        currentPage -= 1;
        axios.get("http://localhost:8081/rest/user/grade/"+id+"?pageNumber="+currentPage+"&pageSize="+this.state.usersPerPage+"&sortBy=firstName&sortDir="+this.state.sortDir)
                                    ...
                                    {users.length === 0 ?
                                        ...
                                        users.map((user, index) => (
                                            ...
                                            <tr key={index}>
                                                ...
                                                <td>{user.email}</td>
                                                <td>
                                                <Button size="sm" variant="outline-danger" onClick={this.deassignPupil.bind(this, user.id)}><FontAwesomeIcon icon={faTrash} /></Button>
                                                </td>
                                            </tr>
                                            : 
                                            null
...
export default connect(mapStateToProps, mapDispatchToProps)(GradePupil);