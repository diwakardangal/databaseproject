...
class GradeByTeacher extends Component {
                              ...
                              <tbody>
                                {
                                    ...
                                    subjects.map((subject) => (
                                        subject.teacher.username == localStorage.getItem('username') ? 
                                        <tr key={subject.id}>
                                            <td>{subject.id}</td>
                                            <td>{subject.subjectName}</td>
                                            <td>{subject.classes.className}</td>
                                            <td>{subject.teacher.firstName} {subject.teacher.lastName}</td>
                                            <td> <Link to={"/exambyteachersubject/"+subject.id} className="btn btn-sm btn-outline-warning">Manage Tests</Link>{' '}</td>
...
export default connect(mapStateToProps, mapDispatchToProps)(GradeByTeacher);