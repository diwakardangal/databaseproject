...
class SubjectByClass extends Component {
                              ...
                              <tbody>
                                {
                                    ...
                                    subjects.map((subject) => (
                                        subject.classes.id == +this.props.match.params.id ? 
                                        <tr key={subject.id}>
                                            <td>{subject.id}</td>
...
export default connect(mapStateToProps, mapDispatchToProps)(SubjectByClass);